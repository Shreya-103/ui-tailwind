...
const Hero = () =>{
    return(
      ...
      <div className="flex flex-col self-start w-1/2 sm:w-1/3 mt-4">
        ...
        <h2 className="text-black text-2xl sm:text-5xl font-bold">customer</h2>
        <h2 className="text-black text-2xl sm:text-5xl font-bold">Segmentation</h2>
      ...
      {/* RIGHT SIDE MAIN */}
        {/* <div className="w-full sm:w-1/2 ml-0 sm:ml-12 overflow-x-auto"> */}
